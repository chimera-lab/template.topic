...
- [:file\_folder: Chimera-lab - README Documents Syntax Rules](./#file_folder-chimera-lab---readme-documents-syntax-rules)
  - [:book: Table of Contents](./#book-table-of-contents)
  - [:book: Repository](./#book-repository)
    - [:book: Name](./#book-name)
    - [:book: Projects](./#book-projects)
      - [:book: Stages](./#book-stages)
    - [:book: Commits](./#book-commits)
    - [:book: Issues](./#book-issues)
      - [:book: Milestones](./#book-milestones)
      - [:book: Labels](./#book-labels)
        - [:book: Common](./#book-common)
        - [:book: General](./#book-general)
        - [:book: Infrastructure](./#book-infrastructure)
        - [:book: Interface](./#book-interface)
        - [:book: Embedded](./#book-embedded)
        - [:book: Study](./#book-study)
    - [:book: Branchs](./#book-branchs)
    - [:book: Templates](./#book-templates)
      - [:book: List of Templates](./#book-list-of-templates)
      - [:book: Child MarkDown Documentation](./#book-child-markdown-documentation)
      - [:book: Document Headers](./#book-document-headers)
        - [:paperclip: Appendix](./#paperclip-appendix)
        - [:book: {doc.chapter}](./#book-docchapter)
        ...
        - [:book: {doc.guide}](./#book-docguide)
        - [:book: {doc.step}](./#book-docstep)
        ...
        - [:puzzle\_piece: Components](./#puzzle_piece-components)
        ...
        - [:card\_file\_box: Submodules](./#card_file_box-submodules)
        - [:book: Table of Contents](./#book-table-of-contents-1)
        ...
        - [:file\_folder: {Chimera LAB's repository name}](./#file_folder-chimera-labs-repository-name)
      - [:book: Link prefixes](./#book-link-prefixes)
        - [:globe\_with\_meridians: External link](./#globe_with_meridians-external-link)
        - [:file\_folder: Chimera LAB's repositories](./#file_folder-chimera-labs-repositories)
        - [:file\_cabinet: Other repositories](./#file_cabinet-other-repositories)
        - [:mag: Terms](./#mag-terms)
